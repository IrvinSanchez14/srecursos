...
<head>
  ...
  <title>Células NICE Registros - Secretaria de Asuntos Espirituales</title>
  <!-- Bootstrap core CSS-->
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><button type="button" class="btn btn-danger">Cancealar</button></td>
                </tr>
                <tr>
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td>Activo</td>
                  <td><button type="button" class="btn btn-success">Modificar</button></td>
                  <td><button type="button" class="btn btn-danger"Cancelarr</button></td>
                </tr>
                <tr>
                  <td>Tiger Nixon</td>
                  <td>2013985361</td>
