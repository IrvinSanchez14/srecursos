                ...
                $('.edit').click(function(event){
                    ...
                    $.ajax({
                        ...
                        success : function(result) {
                            ...
                            modal += '            <input type="text"  maxlength="50" class="form-control" id="inputNombre1" placeholder="Ejemplo Juan Pérez">';
                            modal += '          </div>';
                            modal += '            <div class="form-group col-md-4">';
                            modal += '                <label for="inputcarnet1">CIF</label>';
                            modal += '                <input type="text"  maxlength="10" class="form-control" id="inputcarnet1" placeholder="2016010000">';
                            modal += '              </div>';
                            modal += '            <div class="form-group col-md-4">';
                            modal += '                <label for="inputaño1">Año en que se realiza la actividad</label>';
                            modal += '                <input type="text"  maxlength="10" class="form-control" id="inputaño1" placeholder="2018">';
                            modal += '            </div>';
                            modal += '          </div> ';
                            modal += '            <div class="form-row">';
                            modal += '            <div class="form-group col-md-4">';
                            modal += '              <label for="inputEmail4">Correo Electrónico</label>';
                            modal += '              <input type="email" maxlength="50" class="form-control" id="inputEmail4" placeholder="Ejemplo@hotmail.com">';
                            modal += '            </div>';
                            modal += '            <div class="form-group col-md-4">';
                            modal += '              <label for="inputTel4">Teléfono</label>';
                            modal += '              <input type="text"  maxlength="8" class="form-control" id="inputTel4" placeholder="1122-3344">';
                            modal += '            </div>';
                            modal += '            <div class="form-group col-md-4">';
                            modal += '              <label for="inputCarrera">Facultad</label>';
                            modal += '              <select id="inputCarrera" class="form-control">';
                            modal += '                <option selected>Seleccione una Facultad</option>';
                            modal += '                <option>Ingeniería en Sistemas Computacionales</option>';
                            ...
                            modal += '                <input type="text"  maxlength="50" class="form-control" id="inputFacebook" placeholder="Ejemplo Juan Martínez">';
                            modal += '              </div>';
                            modal += '              <div class="form-group col-md-4">';
                            modal += '                <label for="inputExpectativa">Expectativas sobre futuras actividades de SAE</label>';
                            modal += '                <input type="text"  maxlength="250" class="form-control" id="inputExpectativa" placeholder="Escriba la expectativa del estudiante">';
                            modal += '              </div>';
                            modal += '              <div class="form-group col-md-4">';
                            modal += '                <label for="inputIdeas">Ideas aportadas por el estudiante</label>';
                            modal += '                <input type="text"  maxlength="250" class="form-control" id="inputIdeas" placeholder="Escriba las ideas que brindó del estudiante">';
                            modal += '              </div>';
                            modal += '              </div>';
                            modal += '        <div class="form-row">';
                            modal += '            <div class="form-group col-md-4">';
                            ...
                            modal += '            <input type="text" class="form-control" id="inputNombre1" placeholder="Escriba el nombre de la iglesia">';
                            modal += '            </div>';
                            modal += '            <div class="form-group col-md-4">';
                            modal += '              <label for="inputAno">Años asistidos</label>';
                            modal += '              <input type="text"  maxlength="2" class="form-control" id="inputAnos" placeholder="Ingrese los años asistidos">';
                            modal += '            </div>';
                            modal += '          </div>';
                            modal += '      </form>';
                            modal += '    </div>';
