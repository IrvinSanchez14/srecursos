    ...
    function table() { 
        ...
        $.ajax({
            ...
            success : function(result) {
                ...
                $("#tablaNice").append('<thead><tr> <th>ID</th> <th>Nombre</th> <th>CIF</th> <th>Ciclo Actual</th> <th>Email</th> <th>Telefono</th> <th>Facultad</th> <th>Facebook</th> <th>Beneficio Adquirido</th> <th>Asistencia Religiosa</th> <th>Nombre de Iglesia</th> <th>Opinion</th> <th>Desición Tomada</th> <th>Modificar</th> <th>Eliminar</th> </tr> </thead> <tbody>');
                var num;
                $.each(result.records, function(k,v){
                    let ciclo, asistencia, opinion, desicion,html;
                    ...
                    $('.edit').click(function(event){
                        ...
                        {
                       $.ajax({
                            url: "http://173.255.192.4/api-sreportes/coment_act/readId.php?id_alumno="+num,
                            type : "GET",
                            contentType : 'application/json',
                            success : function(result) {
                                ...
                                $('#create-conferencia-form').attr('id_alumno', num);
                            },
                            error: function(xhr, resp, text) {
                                // show error to console
                                console.log(xhr, resp, text);
                ...
                $("#tablaNice").append('</tbody><tfoot><tr> <th>ID</th> <th>Nombre</th> <th>CIF</th> <th>Ciclo Actual</th> <th>Email</th> <th>Telefono</th> <th>Facultad</th> <th>Facebook</th> <th>Beneficio Adquirido</th> <th>Asistencia Religiosa</th> <th>Nombre de Iglesia</th> <th>Opinion</th> <th>Desición Tomada</th> <th>Modificar</th> <th>Eliminar</th> </tr></tfoot>');
                $("#tableN").append('</table>');
                $("#tablaNice").DataTable();
